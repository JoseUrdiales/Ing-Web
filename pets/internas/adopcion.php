...
<div class="contenedor">
	...
	<main>
		...
		<form method="post" action="procesar.php">
			...
			<div class="grupoinput">
				<label for="cedula">Cedula <span class="rojo">*</span></label>
				<input type="number" id="cedula" name="cedula" placeholder="Ingrese su cedula" required>
			</div>
			<div class="grupoinput">
				<label for="direccion">Direccion <span class="rojo">*</span></label>
				<input type="text" id="direccion" name="direccion" placeholder="Ingrese su direccion" required>
			</div>
			<div class="grupoinput">
				<label for="fechanacimiento">Fecha Nacimiento <span class="rojo">*</span></label>
